...
@router.get('/countries', response_model=List[res_exa.country])
...
# return 登録されている国名を全て取得 object
@router.get('/countries/{country_id}', response_model=res_exa.country)
...
@router.get('/countries_detail', response_model=List[res_exa.country_detail])
...
@router.get('/countries_detail/{country_id}', response_model=res_exa.country_detail)
